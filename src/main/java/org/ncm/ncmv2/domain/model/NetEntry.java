...
public class NetEntry {
    ...
    @ManyToOne(fetch = FetchType.LAZY) @JoinColumn(name = "net_id", nullable = false)
    @ToString.Exclude
    private Net net;
    ...
    @Enumerated(EnumType.STRING) private EntryRole entryRole;
    @Enumerated(EnumType.STRING) private EntryMode entryMode;
    @Enumerated(EnumType.STRING) private EntryStatus entryStatus;
    ...
    @org.hibernate.annotations.Type(
            io.hypersistence.utils.hibernate.type.interval.PostgreSQLIntervalType.class)
