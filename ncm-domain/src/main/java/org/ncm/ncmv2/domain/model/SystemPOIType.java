...
@Entity @Table(name="system_poi_type")
...
public class SystemPOIType {
  ...
  @Column(name="poi_type_name", length=25, nullable=false) private String poiTypeName;
  @Lob @Column(name="poi_type_image") private byte[] poiTypeImage;
}
